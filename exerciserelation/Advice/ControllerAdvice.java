package com.example.exerciserelation.Advice;
...
public ResponseEntity<ApiResponse> JpaSystemException(JpaSystemException systemException){
        String msg=systemException.getMessage();
    return ResponseEntity.status(400).body(new ApiResponse(msg));
